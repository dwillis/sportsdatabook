...
dllink <- download_link(
  link = "https://dwillis.github.io/sportsdatafiles/footballlogs21.csv",
...
ggplot() + 
  ...
  labs(title = "Maryland's defense needs more takeaways", y="Team")
```

How about some layering? 

```{r}
umd <- turnovers %>% filter(Team == "Maryland")
```
...
ggplot() + 
  ...
  theme_minimal() + 
  labs(title = "Maryland's defense was as bad as you think", y="Team")
```
