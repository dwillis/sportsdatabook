...
The CSV file we're going to read from is a [Basketball Reference](https://www.basketball-reference.com/leagues/NBA_2022_advanced.html) page of advanced metrics for NBA players this past season. The Sports Reference sites are a godsend of data, a trove of stuff, and we're going to use it a lot in this class.
...
dllink <- download_link(
  link = "https://dwillis.github.io/sportsdatafiles/nbaadvancedplayers2122.csv",
...
```{r}
nbaplayers <- read_csv("~/code/sportsdatafiles/nbaadvancedplayers2122.csv")
```
...
What if we wanted to know how many players there were by position? To do that by hand, we'd have to take each of the 812 records and sort them into a pile. We'd put them in groups and then count them.
