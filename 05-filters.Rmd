...
dllink <- download_link(
  link = "https://dwillis.github.io/sportsdatafiles/players21.csv",
  button_label = "Download csv file",
  button_type = "danger",
  has_icon = TRUE,
  icon = "fa fa-save",
...
```
In the COVID season, Weber State's Jake Furgerson is your One Shot One Three True Shooting champion.
