...
dllink <- download_link(
  link = "http://dwillis.github.io/sportsdatafiles/footballlogs21.csv",
...
```
Well, what do you know about that? Maryland was ... slightly above average last season, but it didn't translate into wins.
