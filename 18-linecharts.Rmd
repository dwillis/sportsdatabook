...
dllink <- download_link(
  link = "https://dwillis.github.io/sportsdatafiles/logs21.csv",
...
So visually speaking, the difference between Maryland and Michigan State's season is that while both had some significant variations shooting the ball, Maryland's positive outliers were greater and Michigan State's low points were lower.
...
What do we see here? How has Maryland and Michigan State's season evolved against all the rest of the teams in college basketball?
