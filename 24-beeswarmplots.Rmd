...
dllink <- download_link(
  link = "https://dwillis.github.io/sportsdatafiles/players22.csv",
...
The median number of shots is 94, but we only really care about good ones. So let's use 200 attempts -- the third quartile -- as our cutoff. 

```{r}
shooters <- activeplayers %>% filter(FGA > 200)
```
...
You can see that there's a lot fewer centers who have attempted more than 200 shots than guards, but then there's a lot more guards in college basketball than anything else. In the guards column, note that fat width of the swarm is between .5 and .6. So that means most guards who shoot more than 200 shots end up in that area. They're the average shooter at that level. You can see, some are better, some are worse. 
...
Three Terps took more than 200 shots. Number returning this season? One.
...
So Fatts Russell was our best shooter by true shooting percentage, although Donta Scott wasn't far behind. 
