...
```{r}
ggplot() + 
  geom_bar(data=top10, aes(x=Institution, weight=`2019`))
```
...
```{r}
ggplot() + geom_bar(data=top10, aes(x=reorder(Institution, `2019`), weight=`2019`))
```
...
```{r}
ggplot() + 
  geom_bar(data=top10, aes(x=reorder(Institution, -`2019`), weight=`2019`)) + 
