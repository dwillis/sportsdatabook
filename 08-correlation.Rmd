...
To do this, we need all FBS college football teams and their season stats from that year. How much, over the course of a season, does a thing matter? That's the question you're going to answer. 
...
Third, the coefficients: In this case, our `y=mx+b` formula looks like `y = 0.101704x + 0.311030`. So if we were applying this, let's look at Nebraska's 26-20 loss to Iowa in 2020. Nebraska's net yards that game? 16. That's right -- positive net yards, but still a loss. What does our model say the point differential should have been?  
