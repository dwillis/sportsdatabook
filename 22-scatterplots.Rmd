...
dllink <- download_link(
  link = "https://dwillis.github.io/sportsdatafiles/logs1520.csv",
...
The p-value isn't random. The adjusted R-squared is pushing 40 percent. We've got something here. Let's use our coefficients to look at Nebraska's 2019-2020 season (not the COVID season, because all the numbers are super weird in that season).
